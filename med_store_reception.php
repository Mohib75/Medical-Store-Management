...
{
    ?>
    <option value = "<?php echo $row['name'].','.$row['buy_timestamp'].','.$row['expiry_date'].','.$row['chem_amount'].','.$row['cp'].','.$row['sp']; ?>"><?php echo $row[ 'name' ].','.$row[ 'chem_amount' ].','.$row[ 'expiry_date' ].','.$row[ 'sp' ];
    ?></option>
    <?php
}
?>
